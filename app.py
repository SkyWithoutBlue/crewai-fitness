                    ...
                    if mode == "📝 Полный контент-пак (Пост + Сценарий + Воронка в Директ + А/Б Хуки + Telegram)":
                        ...
                        reels_task = Task(
                            description=(
                                ...
                                f"- 🎙️ **ПОЛНЫЙ, слово-в-слово дикторский текст (что говорить на камеру)**. Пропиши конкретную, живую и эмоциональную речь Людмилы для каждого тайминга. Никаких общих фраз типа 'рассказывает про упражнение', только точный дословный готовый текст для чтения вслух!\n"
                            ...
                            expected_output="Детализированный сценарий Reels с таймингами, ракурсами, звуками и полным дословным дикторским текстом для чтения вслух на камеру.",
                            agent=reels_creator,
                        ...
                        reels_task = Task(
                            description=(
                                ...
                                f"- 🎙️ **ПОЛНЫЙ, слово-в-слово дикторский текст (что говорить на камеру)**: Пропиши дословный текст, который Людмила должна произносить вслух, чтобы ей было легко наговорить его на камеру."
                            ),
                            expected_output="Сценарий Reels с ракурсами, музыкой и полным дословным дикторским текстом для озвучки.",
                            agent=reels_creator,
                            output_file=reels_file
                        )
                        ...
                        reels_task = Task(
                            description=(
                                ...
                                f"- 🎙️ **ПОЛНЫЙ, слово-в-слово дикторский текст (что говорить на камеру)**: Пропиши готовый текст озвучки для Людмилы, который она произнесет на камеру без необходимости придумывать слова на ходу."
                            ),
                            expected_output="Промо-сценарий Reels с ракурсами, музыкой и готовым дикторским текстом.",
                            agent=reels_creator,
                            output_file=reels_file
                        )
                        ...
                        reels_task = Task(
                            description=(
                                ...
                                "Обязательно напиши **ПОЛНЫЙ, слово-в-слово дикторский текст (что именно говорить на камеру)** для каждого видео, чтобы Людмила могла просто прочесть готовый текст.\n"
                                ...
                                "- **🎙️ Дикторский текст (что говорить на камеру слово-в-слово):** [Полноценный готовый текст для озвучки]\n"
                            ...
                            expected_output="10 детально прописанных идей Reels с четкой структурой, визуалом и полным дикторским текстом для каждой идеи.",
                            agent=reels_creator,
                        ...
                        reels_task = Task(
                            description=(
                                ...
                                "- 🎙️ **ПОЛНЫЙ, слово-в-слово дикторский текст (что говорить на камеру / озвучивать)**: Пропиши готовый дикторский текст для озвучки, который Людмила прочитает голосом за кадром или на камеру.\n"
                                "- Звуковое сопровождение (ритмичный трек, ASMR-звуки нарезки, шипения сковороды, бурления воды)."
                            ),
                            expected_output="Кулинарный сценарий Reels с ASMR, раскадровкой и готовым закадровым текстом для озвучки.",
                            agent=reels_creator,
                            output_file=reels_file
                        )
                        ...
                        reels_task = Task(
                            description=(
                                ...
                                f"Для каждого из 5 хуков обязательно пропиши **🎙️ ПОЛНЫЙ, слово-в-слово дикторский текст (что говорить на камеру)**, чтобы Людмила знала, какие именно слова сказать для каждой идеи."
                            ),
                            expected_output="5 сценариев видеоряда под А/Б хуки с точными ракурсами и дословным текстом для озвучки.",
                            agent=reels_creator,
                            output_file=reels_file
                        )
